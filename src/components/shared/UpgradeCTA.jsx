...
export default function UpgradeCTA() {
  ...
  return (
    <div className="mx-3 mb-4 rounded-xl bg-gradient-to-br from-[#1a3554] to-[#24466f] p-4" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <p className="text-xs text-white/60 mb-3 leading-relaxed">
        {isRTL
          ? `قم بالترقية للحصول على المزيد من المستخدمين والميزات المتقدمة.`
