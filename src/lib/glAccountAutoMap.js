...
const ROLE_RULES = {
  ...
  freight_accrual:    { types: ['liability'],                  keywords: ['freight accrual', 'freight payable', 'carriage payable', 'freight clearing', 'freight & other', 'freight and other', 'freight', 'fright', 'carriage', 'cartage', 'transport'] },
